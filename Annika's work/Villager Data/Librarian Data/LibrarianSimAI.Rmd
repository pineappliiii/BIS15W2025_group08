...
villager_data <- read_csv("librarian_clean_2.csv")
...
```{r}
write.csv(villagers_full_sample, "librarian_sim_data.csv", row.names = FALSE)
librarian <- read_csv("librarian_sim_data.csv")
```