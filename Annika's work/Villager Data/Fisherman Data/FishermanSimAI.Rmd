...
villager_data <- read_csv("fisherman_clean_2.csv")
...
```{r}
write.csv(villagers_full_sample, "fisherman_sim_data.csv", row.names = FALSE)
fisherman <- read_csv("fisherman_sim_data.csv")
```