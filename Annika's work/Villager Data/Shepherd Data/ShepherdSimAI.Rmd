...
villager_data <- read_csv("shepherd_clean_2.csv")
...
```{r}
write.csv(villagers_full_sample, "shepherd_sim_data.csv", row.names = FALSE)
shepherd <- read_csv("shepherd_sim_data.csv")
```