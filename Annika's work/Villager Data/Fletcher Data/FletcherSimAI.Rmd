...
villager_data <- read_csv("fletcher_clean_2.csv")
...
```{r}
write.csv(villagers_full_sample, "fletcher_sim_data.csv", row.names = FALSE)
fletcher <- read_csv("fletcher_sim_data.csv")
```